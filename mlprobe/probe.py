...
Invocation::
    ...
    python -m mlprobe.probe <probe_input.json>
...
The runner (``mlprobe.runner``) is what produces probe_input.json files and
...
def _cli() -> int:
    parser = argparse.ArgumentParser(prog="mlprobe.probe")
